...
class AgenteInAttivitaFinanziariaSeeder extends Seeder
{
    /**
    ...
    {
        $csvPath = storage_path('app/private/EsportazioneElencoAgentiInAttivitaFinanziaria.csv');
        ...
        $this->command->info("Successfully imported {$rowCount} agenti in attività finanziaria.");
    }
